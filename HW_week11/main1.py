...
def get_destination(destination_id):
    ...
    if destination:
        # Исправлено: destination.to_dict() вместо destination_id.to_dict()
...
# Исправлен путь: "/destinations/" вместо "/destination/"
...
def update_destination(destination_id):
    ...
    if destination:
        ...
        destination.country = data.get(
            "country", destination.country)  # Исправлено
        destination.rating = data.get(
            "rating", destination.rating)     # Исправлено
